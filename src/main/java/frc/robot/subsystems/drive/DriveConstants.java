...
public class DriveConstants {
  ...
  public static final Rotation2d frontLeftZeroRotation = new Rotation2d(2.053);
  public static final Rotation2d frontRightZeroRotation = new Rotation2d(-1.204);
  public static final Rotation2d backLeftZeroRotation = new Rotation2d(2.21);
  public static final Rotation2d backRightZeroRotation = new Rotation2d(1.528);
  ...
  public static final int backLeftCANcoderCanId = 34;
  public static final int frontRightCANcoderCanId = 32;
  public static final int backRightCANcoderCanId = 33;

  // Drive motor configuration
  public static final int driveMotorCurrentLimit = 60;
  public static final double wheelRadiusMeters = Units.inchesToMeters(1.5);
  public static final double driveMotorReduction =
      (50.0/14.0) * (16.0/28.0) * (45.0/15.0); // SDS MK4i L3, overall ~6.12:1
  ...
  public static double driveKv = 0.12;
  ...
  public static final double autonTranslationKp = 0.5;
